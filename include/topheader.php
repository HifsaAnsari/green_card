                ...
                <div class="container">
                    ...
                    <div class="icon-box icon-box-side">
                            ...
                            <div class="icon-box-content d-lg-show">
                                <h4 class="icon-box-title text-dark text-normal">Call Us Now:</h4>
                                <p><a href="tel:#">123456789</a></p>
                            </div>
                                ...
                                <div class="products scrollable">
                                    <div class="product product-cart">
                                        ...
                                        <div class="product-detail">
                                            <a href="demo5-product.php" class="product-name">Riode White Trends</a>
                                            <div class="price-box">
                                    ...
                                    <div class="product product-cart">
                                        ...
                                        <div class="product-detail">
                                            <a href="demo5-product.php" class="product-name">Dark Blue Women’s
                                                Leomora Hat</a>
                                            <div class="price-box">
                                                <span class="product-quantity">1</span>
