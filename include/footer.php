<footer class="footer appear-animate">
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo5.html" class="logo-footer">
                                    <img src="images/demos/demo5/logo-footer.png" alt="logo-footer" width="150"
                                        height="43" />
                                </a>
                                <div class="widget-body">
                                    ...
                                    <a href="mailto:mail@Greencard.com">gvs@example.com</a>
                                </div>
                            </div>
                            <!-- End of Widget -->
                        </div>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-center">
                        <p class="copyright">GVS&copy; 2021. All Rights Reserved</p>
                    </div>
    ...
    <div class="sticky-footer sticky-content fix-bottom">
        <a href="demo5.php" class="sticky-link active">
            <i class="d-icon-home"></i>
            <span>Home</span>
        </a>
        <!-- <a href="demo5-shop.php" class="sticky-link">
        ...
        <div class="mobile-menu-container scrollable">
            ...
            <div class="tab tab-nav-simple tab-nav-center tab-nav-boxed">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a href="#tab-1" class="nav-link active">Main Menu</a>
                    </li>
                    
                </ul>
            </div>

            <ul class="mobile-menu mmenu-anim tab-content">
                <div class="tab-pane active" id="tab-1">
                    <li>
                        <a href="demo5.php">Home</a>
                    </li>
                    <li> 
						<a href="hotel-booking.php">Flight & Hotel Booking</a>
					</li>
					<li> 
					<a href="e-store.php">Estore</a>
					</li>
					<li> 
					<a href="coupon-products.php">Coupons</a>
					</li>
					<li> 
                    ...
                    <!-- <li>
                        <a href="demo5-shop.php">Categories</a>
                        <ul>
                            <li>
                                <a href="#">
                                    Variations 1
                    ...
                    <li> 
                        <a href="demo5-shop.php" class="active">Products</a>
                          <!--<ul>
                            <li>
                               ...
                               <ul>
                                    ...
                                    <li><a href="product-sticky-cart.php">Add Cart Sticky<span
                                                class="tip tip-hot">Hot</span></a></li>
                    ...
                    <li> 
								<a href="coupon_detail.php" class="btn-coup-sec_mobile"> Get Coupon</a>
								</li>
                    <!-- <li>
                        <a href="#">Pages</a>
                        <ul>
                            <li><a href="about-us.ph">About</a></li>
                    ...
                    <!-- <li><a href="Greencard.html">Buy Greencard!</a></li>
                </div>
                <div class="tab-pane" id="tab-2">
                    <li>
                        <a href="demo5-shop.php"><i class="d-icon-camera1"></i>Electronics</a>
                    </li>
                    <li>
                        <a href="demo5-shop.php"><i class="d-icon-officebag"></i>Backpacks &amp;
                            Fashion bags</a>
                    </li>
                    <li>
                        <a href="demo5-shop.php"><i class="d-icon-gamepad1"></i>Gaming &amp;
                            Accessories
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="demo5-shop.php"><i class="d-icon-desktop"></i>Computer
                        </a>
                    </li>
                    <li>
                        <a href="demo5-shop.php"><i class="d-icon-cook"></i>Home &amp; Kitchen</a>
                    </li>
                    <li><a href="demo5-shop.php" class="menu-title">Today Coupon Deals</a>
                    </li>
                    <li>
                        <a href="demo5-shop.php">
    ...
    <div class="newsletter-popup mfp-hide" id="newsletter-popup" style="background-image: url(images/newsletter-popup.jpg)">
        <div class="newsletter-content">
            ...
            <h2 class="font-weight-semi-bold">Sign up to <span>Greencard</span></h2>
            <p class="text-grey">Subscribe to the Greencard eCommerce newsletter to receive timely updates from your favorite
                products.</p>
