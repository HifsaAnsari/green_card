...
$.extend($.easing, {
    ...
    (Riode.defaults = {
        ...
        templateCartAddedAlert:
            '<div class="alert alert-simple alert-btn cart-added-alert"><a href="cart.php" class="btn btn-success btn-md">View Cart</a><span>"{{name}}" has been added to your cart.</span><button type="button" class="btn btn-link btn-close"><i class="d-icon-times"></i></button></div>',
                        ...
                        e.$wrapper.on("click", ".btn-cart", function (t) {
                            ...
                            (i.closest(".product-popup").length || document.body.classList.contains("home")) &&
                                Riode.Minipopup.open({
                                    ...
                                    actionTemplate:
                                        '<div class="action-group d-flex mt-3"><a href="cart.php" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="checkout.php" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                });
                        });
                    })(this);
            }),
    ...
    (Riode.initProductSinglePage = (function () {
        ...
        function i(e) {
            ...
            t.hasClass("added") ||
                ...
                setTimeout(function () {
                    t.removeClass("load-more-overlay loading").html('<i class="d-icon-heart-full"></i> Browse wishlist').addClass("added").attr("title", "Browse wishlist").attr("href", "wishlist.php");
                }, 500));
        }
        return function () {
                ...
                .on("click", ".product:not(.product-variable) .btn-product-icon.btn-cart, .product:not(.product-variable) .btn-product.btn-cart", function (e) {
                    ...
                    t.hasClass("product-single") ||
                        Riode.Minipopup.open({
                            ...
                            actionTemplate:
                                '<div class="action-group d-flex"><a href="cart.php" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="checkout.php" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                        });
                });
        },
